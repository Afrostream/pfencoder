...
mp4split="mp4split \
	--license-key ${KEY} \
        ...
        --iss.license_server=https://lic.drmtoday.com/license-proxy-headerauth/drmtoday/RightsManager.asmx \
	--iss.minimum_fragment_length=8 \
        --widevine.key=${USPCENCKeyId}:${drmCENCKey} \
        --widevine.license_server_url=https://lic.drmtoday.com/license-proxy-widevine/cenc/ \
        --hls.playout=clear \
        ...
        --hds.license_server=https://lic.drmtoday.com/flashaccess/LicenseTrigger/v1 \
