...
mp4split="mp4split \
	--license-key ${KEY} \
	--iss.playout clear --iss.minimum_fragment_length=4 \
	--hls.playout clear --hls.minimum_fragment_length=4 --hls.no_audio_only --hls.client_manifest_version=4 \
	--hds.playout false \
	--mpd.playout clear --mpd.minimum_fragment_length=4 \
